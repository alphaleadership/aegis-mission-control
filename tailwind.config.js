...
export default {
  ...
  theme: {
  	extend: {
  		...
  		colors: {
        'brand-dark': 'rgb(10, 10, 20)',
        'brand-cyan': 'rgb(52, 152, 219)',
        'brand-orange': 'rgb(243, 156, 18)',
  		...
  		boxShadow: {
  			...
  			glow: '0 0 20px -5px rgba(52, 152, 219, 0.4)',
  			'glow-lg': '0 0 40px -10px rgba(52, 152, 219, 0.3)',
  			primary: '0 0 20px -5px hsl(var(--primary) / 0.4)',
  			glass: '0 8px 32px 0 rgba(31, 38, 135, 0.37)'
  		},
  		keyframes: {
        'pulse-glow': {
          '0%, 100%': { opacity: 1, boxShadow: '0 0 10px #3498db' },
          '50%': { opacity: 0.7, boxShadow: '0 0 20px #3498db' },
        },
  			'fade-in': {
  				'0%': {
  					opacity: '0',
  			...
  			glow: {
  				'0%, 100%': {
  					boxShadow: '0 0 20px -5px rgba(52, 152, 219, 0.4)'
  				},
  				'50%': {
  					boxShadow: '0 0 40px -5px rgba(52, 152, 219, 0.6)'
  				}
  			},
  			float: {
  				'0%, 100%': {
